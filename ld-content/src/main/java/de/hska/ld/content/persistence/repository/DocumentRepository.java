...
public interface DocumentRepository extends CrudRepository<Document, Long> {
    ...
    @Query("SELECT d FROM Document d LEFT JOIN d.accessList al WHERE (al.user = :user OR d.creator = :user OR d.accessAll = true) AND (d.deleted = false OR d.deleted IS NULL)")
