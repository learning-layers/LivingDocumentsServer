...
public interface DocumentService extends ContentService<Document> {
    ...
    Document addAccessWithoutTransactional(Long documentId, String userIds, String permissions);
    ...
    boolean checkPermissionSave(Document document, Access.Permission permission);
