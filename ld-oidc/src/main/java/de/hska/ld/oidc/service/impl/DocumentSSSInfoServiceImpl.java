...
import de.hska.ld.oidc.persistence.repository.DocumentSSSInfoRepository;
...
@Service
public class DocumentSSSInfoServiceImpl implements DocumentSSSInfoService {

    @Autowired
    private DocumentSSSInfoRepository repository;

    @Override
    @Transactional
    public void addDocumentInfo(DocumentSSSInfo documentSSSInfo) {
        repository.save(documentSSSInfo);
    }
